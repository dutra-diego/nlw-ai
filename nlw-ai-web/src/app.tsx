    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
         ...
         <div className="flex items-center gap-3">
            <span className="text-sm gap-3 text-muted-foreground">Desenvolvido com 💜 no NLW da Rocketseat</span>
        ...
        <aside className="w-80 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">Valores mais altos tendem a deixar o resultado mais
               criativo e com possiveis erros.</span>
            </div>
